    ...
    >
      {isOpen && (
        <div className="flex flex-col gap-3">
          {/* WhatsApp */}
          <a
            href="https://wa.me/27788630783"
            target="_blank"
            rel="noopener noreferrer"
            className="bg-[#25D366] text-white p-3 rounded-xl shadow-lg hover:bg-[#22BF5B] transition-all hover:scale-110 hover:shadow-xl flex items-center justify-center"
